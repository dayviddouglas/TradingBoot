package com.github.dayviddouglas.TradingBoot.deriv.ws;

/**
 * Contrato para recebimento de ticks em tempo real vindos da API Deriv.
 *
 * Registrada no {@link com.github.dayviddouglas.TradingBoot.deriv.DerivMarketDataService}
 * e implementada pelo {@code MultiSymbolDerivBotRunner} via lambda para rotear cada tick
 * ao {@link com.github.dayviddouglas.TradingBoot.market.TickCandleAggregator}
...
public interface TickHandler {
    ...
    /**
     * Invocado pelo {@link com.github.dayviddouglas.TradingBoot.deriv.DerivMarketDataService}
